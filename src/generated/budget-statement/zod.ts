...
export function AddAuditReportActionSchema(): z.ZodObject<Properties<AddAuditReportAction>> {
  return z.object<Properties<AddAuditReportAction>>({
    attachments: z.array(z.lazy(() => DocumentFileInputSchema())),
